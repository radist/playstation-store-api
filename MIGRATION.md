...
// API base URL uses default: 'https://web.np.playstation.com/api/graphql/v1/'
$client = ClientFactory::create(RegionEnum::UNITED_STATES);
```

#### v3.0.0 (Custom base URI)
```php
use PlaystationStoreApi\ClientFactory;
use PlaystationStoreApi\Enum\RegionEnum;

// Use custom base URI for testing, staging, or different endpoints
$client = ClientFactory::create(
    RegionEnum::UNITED_STATES,
    null, // httpClient (auto-detected)
    null, // requestFactory (auto-detected)
    null, // serializer (auto-created)
    'https://custom-endpoint.example.com/api/graphql/v1/' // baseUri
);
```
...
$client = ClientFactory::create(
    ...
    $requestFactory,
    null, // serializer (auto-created)
    'https://custom-endpoint.example.com/api/graphql/v1/' // optional baseUri
);
```
